...
/** NPT Completion-Deficit Potential
 * V(phi) = V_0 * (1 - exp(-alpha * phi))^2
 * where alpha = sqrt(2/3) (Starobinsky coefficient, fixed)
 * V_0 = scf_parameters[0] (tuned by CLASS shooting to match Omega_scf)
 */
